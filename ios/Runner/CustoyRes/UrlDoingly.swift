...
class UrlDoingly {
    ...
    static let shared = UrlDoingly()

    /// 获取麦克风权限
    //: func requestMicPermission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    func third(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func blockIn(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func switchce(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func take(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
