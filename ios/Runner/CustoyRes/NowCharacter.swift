...
/*: "offmarket_loop_ :*/
fileprivate let constPhoneFlag:String = "oheadheadm"
fileprivate let serviceFinishSystemValue:String = "loop_of kind user lab"
...
public class NowCharacter: NSObject {
    
    //: public static let shared = LocalPushScheduler()
    public static let shared = NowCharacter()
    ...
    public func size(times: [Int], contents: [String]) {
        // 清除之前所有的旧推送任务
        ...
        for dayOffset in 0..<7 {
            ...
            for hour in validTimes {
                ...
                content.title = data_mapFormat as! String
                ...
                let identifier = (constPhoneFlag.replacingOccurrences(of: "head", with: "f") + "arket_" + String(serviceFinishSystemValue.prefix(5))) + "\(weekday)_\(hour)"
